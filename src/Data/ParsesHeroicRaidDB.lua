		...
		specs = {
			[65] = {
				...
				[8] = {
					...
					talentString = "CEEAAAAAAAAAAAAAAAAAAAAAAAAAAYBAMDAAsMmZmZGzMzCMGWGbzMLmpJmlZMzMMMbZAYAYDsZWmZmZZ2mZmtGAAAgF2AsBjhZGAAYmhZMGeAA",
					instanceId = 1308,
			...
			[66] = {
				...
				[1] = {
					label = "Rotmire",
					talentString = "CIEAAAAAAAAAAAAAAAAAAAAAAsNjBzyYbMjZmZZZMzwsMLzYAAGAAAAAA00MzyMjZGegxs1GAeAYAzgNAAAAYmZZbplZGLmBPAgBzsZMAYmBAzMIPA",
					instanceId = 1305,
					instanceName = "Sporefall",
				},
				[2] = {
	...
	[4] = {
		specs = {
			...
			[260] = {
				...
				[1] = {
					label = "Rotmire",
					talentString = "CQQAAAAAAAAAAAAAAAAAAAAAAAgx2MYmZmZmtZmZmZMmNeAmZZaZw2MAAAAAgZbbmZGmZmZGzMz2AAAAwYAwY2MMwAzCL0CbMAzMYgHA",
					instanceId = 1305,
					instanceName = "Sporefall",
				},
				[2] = {
	...
	[5] = {
		specs = {
			...
			[258] = {
				...
				[8] = {
					label = "Belo'ren, Child of Al'ar",
					talentString = "CIQAAAAAAAAAAAAAAAAAAAAAAMMjZGAAAAAAAAAAAgxYxMGLzMMz2MDzw2MzYmZGbMZYxMNAzAMziZY2MAkxYBAzAMmZmxsNmZbZAmBPA",
					instanceId = 1308,
					instanceName = "March on Quel'Danas",
				},
				[9] = {
	...
	[6] = {
		specs = {
			...
			[252] = {
				...
				[1] = {
					label = "Rotmire",
					talentString = "CwPAAAAAAAAAAAAAAAAAAAAAAAYmhZMjZYWGzMTjZmxMzYAAAAAAAAYmxwAglZMzsZmxMzA2MbGGYgZjhGLYAzAwYmZMDwMzYGPA",
					instanceId = 1305,
					instanceName = "Sporefall",
				},
				[2] = {
	...
	[7] = {
		specs = {
			[262] = {
				...
				[4] = {
					label = "Vaelgor & Ezzorak",
					talentString = "CYQAAAAAAAAAAAAAAAAAAAAAAAAAAAzMLLzMGjZZbZMmhBAAAAYxMbwAGwsxEYWAgZZmZGzsZmwMjxiZmZMzYWYWwMzMbDAYYWAmZMMjHA",
					instanceId = 1307,
					instanceName = "The Voidspire",
				},
				[5] = {
			...
			[263] = {
				...
				[1] = {
					label = "Rotmire",
					talentString = "CcQAAAAAAAAAAAAAAAAAAAAAAMzMzYMzMzMzMzMzMzAAAAAAAAAsBYzMG2gFYGGawCAzyMmxYZxAzMbjlZmZmBLjZAAMMmBzEYmBDGPA",
					instanceId = 1305,
					instanceName = "Sporefall",
				},
				[2] = {
					label = "Imperator Averzian",
					talentString = "CcQAAAAAAAAAAAAAAAAAAAAAAMzMzYMzMzMzMzMzMzAAAAAAAAAsBYzMG2gFYGGawCAz2MmZGLLzYhZmtxyMzMDjFmBAwwYGMCMzgBjHA",
					instanceId = 1307,
					instanceName = "The Voidspire",
				},
				[3] = {
				...
				[7] = {
					label = "Belo'ren, Child of Al'ar",
					talentString = "CcQAAAAAAAAAAAAAAAAAAAAAAMzMjZmZmZmZmZmZmZGAAAAAAAAAYBWgZsox2AYGwGAzyMmxMLLzAzMbsNzMzwwYGAADwYmJmZAgxDA",
					instanceId = 1308,
					instanceName = "March on Quel'Danas",
				},
				[8] = {
					label = "Midnight Falls",
					talentString = "CcQAAAAAAAAAAAAAAAAAAAAAAMzMzgZmZmZmhZmZAAAAAAAAAsBYzMG2gFYGGawCAzyMmZGLLzAzMbsMzMz8AGLjZAAmhxMDjAzMYw4BA",
					instanceId = 1308,
					instanceName = "March on Quel'Danas",
				},
				[9] = {
	...
	[8] = {
		specs = {
			...
			[63] = {
				...
				[2] = {
					label = "Imperator Averzian",
					talentString = "C8DAAAAAAAAAAAAAAAAAAAAAAMzYZsMzMzCzMjMDzAAAYAAzMTzyyyMAAbmZGbjZmZsBAAAAALmZmZAAgxMMmZmZmlBgZGgxYwM8AA",
					instanceId = 1307,
					instanceName = "The Voidspire",
				},
				[3] = {
			...
			[64] = {
				[0] = {
					label = "All Bosses",
					talentString = "CAEAAAAAAAAAAAAAAAAAAAAAAMzwMLzMzsMMzEzMzYmZmZWMzMMjZAAAgZmZWWmZaDAA2AAAAWAYbZMzMDmthxMjFAAAmZDYGYAzgHA",
				},
				[1] = {
					label = "Rotmire",
					talentString = "CAEAAAAAAAAAAAAAAAAAAAAAAMzwMLzMzsMMzEzMzYmZmZWMzMMjZAAAgZmZWWmZaDAA2AAAAWAYbZMzMDmthxMjFAAAmZDYGYAzgHA",
	...
	[10] = {
		specs = {
			[268] = {
				...
				[3] = {
					label = "Vaelgor & Ezzorak",
					talentString = "CwQAAAAAAAAAAAAAAAAAAAAAAAAAAwMbbGzYmxyM2wMjBAAAAAAYZBjYmBmhZ2YwMzMDz2wMmZZYZzy2YGzCAAsBAAAmtZpZmZWYYDgZGmGDAA4BA",
					instanceId = 1307,
					instanceName = "The Voidspire",
				},
				[4] = {
			...
			[270] = {
				...
				[3] = {
					label = "Vorasius",
					talentString = "C4QAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAgxMMDmFbzMzMzyM2wMzsZmtllZGLMEmBMYYGjZmZGmthZY2MBAAAAmlptZbmlZDAAAgBDzMAwAjlhBA",
					instanceId = 1307,
					instanceName = "The Voidspire",
				},
				[4] = {
	...
	[11] = {
		specs = {
			...
			[105] = {
				...
				[2] = {
					label = "Imperator Averzian",
					talentString = "CkGAAAAAAAAAAAAAAAAAAAAAAMjxMbz2MmZGz2wDwMzixCzAAAAAAAAAAgtBNbMmmZM8AmlZmZmhJzAAAAAAAAAAAAAwsNzSz2Mb2YMzMMzAjmBAYmBgHA",
					instanceId = 1307,
					instanceName = "The Voidspire",
				},
				[3] = {
					label = "Vaelgor & Ezzorak",
					talentString = "CkGAAAAAAAAAAAAAAAAAAAAAAMjxMbz2MmZGz2wDMmxmxCzAAAAAAAAAAgFDNbzMmmZAmlxMzMLmYGAAAAADAwAssN2w0MzyAAAAYBzMGmZsxoZAwMDA4BA",
					instanceId = 1307,
					instanceName = "The Voidspire",
				},
				[4] = {
				...
				[7] = {
					label = "Belo'ren, Child of Al'ar",
					talentString = "CkGAAAAAAAAAAAAAAAAAAAAAAMjxMLjZMzMmthHYMjFsMmBAAAAAAAAAALGa2mZMNzAMLjZmZWMxMAAAAAGAgZAbbjFMNzsMAAAAWwMjBzYjRzAgZGAwDA",
					instanceId = 1308,
					instanceName = "March on Quel'Danas",
				},
				[8] = {
					label = "Midnight Falls",
					talentString = "CkGAAAAAAAAAAAAAAAAAAAAAAMjxMbz2MmZGz2wDYmZYswMAAAAAAAAAAYbQzGjpZGDPgZZmZmZYyMAAAAAAAAAAAAAMbzs0sNzmNGzMDzMwoZAAmZA4BA",
					instanceId = 1308,
					instanceName = "March on Quel'Danas",
				},
				[9] = {
	...
	[12] = {
		specs = {
			[577] = {
				...
				[6] = {
					label = "Belo'ren, Child of Al'ar",
					talentString = "CEkAAAAAAAAAAAAAAAAAAAAAAYGMzMzmxMzMmZmMmZAAAAAAAzyDMmtZYmZ2mZGLz2YGLjZMWmZbGMMW2YCjZGDLAAAAAAAgZGgBAAAgHA",
					instanceId = 1308,
					instanceName = "March on Quel'Danas",
				},
				[7] = {
					label = "Midnight Falls",
					talentString = "CEkAAAAAAAAAAAAAAAAAAAAAAYmZGzMz2MmZmxMzkxMDAAAAAAY2MmtZYmBzM2mt5BmZMGDLDsNLmxwsx0YmZMsBAAAAAAAwMDGAAAAeA",
					instanceId = 1308,
					instanceName = "March on Quel'Danas",
				},
				[8] = {
