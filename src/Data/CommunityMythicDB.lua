...
addonTable.CommunityMythicDB = addonTable.CommunityMythicDB or {}
...
local talentData = {
	...
	[5] = {
		specs = {
			...
			[257] = {
				[0] = {
					label = "wowcompare.io Mythic Delve",
			...
			[258] = {
				[0] = {
					label = "wowcompare.io Voidweaver Mythic",
...
addonTable.CommunityMythicDB = talentData