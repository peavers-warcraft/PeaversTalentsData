...
addonTable.WorldwideMythicDB = addonTable.WorldwideMythicDB or {}
		...
		specs = {
			[71] = {
				...
				[6] = {
					...
					talentString = "CcEAAAAAAAAAAAAAAAAAAAAAAAYYmZMjZMzsNbLLjZAAAAYwYYmhlZMDMzyYmZwMDDDMDDAAAAAAAmxsNYA2wAYzMGWgBmhNMAWA",
				},
				[7] = {
					label = "Grim Batol",
					talentString = "CcEAAAAAAAAAAAAAAAAAAAAAAAYYmZMjZMzsNbLLjZAAAAYwYYmhlZMDMziZmZwMDDDMDDAAAAAAAmxsNYA2wAYzMGWgBmhNMAWA",
	...
	[2] = {
		specs = {
			...
			[70] = {
				[0] = {
					label = "Ara-Kara City of Echoes",
					talentString = "CYEAAAAAAAAAAAAAAAAAAAAAAAAAAYAgB22mZWW2mZsZmZbxsNAAAAAAMbGzwwMjtZwsNMmlZW2GzgZALLsBgxsMbzMzmBAAAWAGAwwYA",
				},
				[1] = {
					label = "The Necrotic Wake",
					talentString = "",
				...
				[4] = {
					label = "Siege of Boralus",
					talentString = "CYEAAAAAAAAAAAAAAAAAAAAAAAAAAYAgBW2mZ2W2mZsZmZbZmNAAAAAAMwMLGmZsNDmthxsMzy2YGMALLsBgxsMLzMzmBAAAWAGAMGmtBA",
				},
				[5] = {
					label = "Mists of Tirna Scithe",
					talentString = "",
	...
	[3] = {
		specs = {
			...
			[255] = {
				...
				[4] = {
					label = "Siege of Boralus",
					talentString = "C8PAAAAAAAAAAAAAAAAAAAAAAMgxM2YgFYbYwglZGbzMzMjxMmZGjZGjZGzAAAAAAAAAAAAAAAzwYGzMzYmhhxwMDzyMmxMYD",
				},
				[5] = {
					label = "Mists of Tirna Scithe",
					talentString = "C8PAAAAAAAAAAAAAAAAAAAAAAMgxM2YgFYbYwglZGbzYmZMmxYMmZMzMzYmBAAAAAAAAAAAAAAzwYmZmZGzghxwMDzyMMmZYD",
	...
	[7] = {
		specs = {
			...
			[263] = {
				...
				[4] = {
					label = "Siege of Boralus",
					talentString = "CcQAAAAAAAAAAAAAAAAAAAAAAMzMDMjZYmZmhZZmZZZMDAAAAAAAAAgNA2MjhNYBmhBDWAwsMMgFjxYwYmtZsMzMmFWmZZMzAAMjB",
				},
				[5] = {
					label = "Mists of Tirna Scithe",
					talentString = "CcQAAAAAAAAAAAAAAAAAAAAAAMzMDMjZYmZmhZZmZZZMDAAAAAAAAAgNA2MjhNYBmhBDWAwsMMgFjxYwYmtZsMzMmFWmZZMzAAMjB",
	...
	[8] = {
		specs = {
			...
			[63] = {
				...
				[2] = {
					label = "The Stonevault",
					talentString = "C8DAAAAAAAAAAAAAAAAAAAAAAMzgZbWwMMzs5B4BMPwMGjZGzAAAAAAwMLzYmZZWAAAALmZmZmZMmZmxixMjZwMzyMWADAAAAAAAA",
				},
				[3] = {
					label = "The Dawnbreaker",
					talentString = "C8DAAAAAAAAAAAAAAAAAAAAAAYGYbWwMegZmN4BMzMGjZGzMAAAAAAmZZGzMLzCAAAYxMzMzMjxYmZWMmZMDmZWmxCLAAAAAAAAA",
				},
				[4] = {
					label = "Siege of Boralus",
				...
				[5] = {
					label = "Mists of Tirna Scithe",
					talentString = "C8DAAAAAAAAAAAAAAAAAAAAAAYGYbWwMmZmFYMzMGjxsMDAAAAAAzsMjZmlZBAAAsYmZmZmxYmZGLmlZGzgZmlZsAAAAAAAAA",
				},
				[6] = {
					label = "City of Threads",
					talentString = "C8DAAAAAAAAAAAAAAAAAAAAAAYMYzCmhZmFYMzMGjZmlZGAAAAAAzsMjZmlZBAAAsYmZmZmxYMzMLGzMmBzMLzYjFAAAAAAAA",
				},
				[7] = {
					label = "Grim Batol",
					talentString = "C8DAAAAAAAAAAAAAAAAAAAAAAMzAbWwMMzs4B4BMzMGjZGzMAAAAAAmZZGzMLzCAAAYxMzMzMjxYmZWMmZMDmZWmxCLAAAAAAAAA",
	...
	[9] = {
		specs = {
			[267] = {
				...
				[1] = {
					label = "The Necrotic Wake",
					talentString = "CsQAAAAAAAAAAAAAAAAAAAAAAAmZmZmZghhxsNzMDzysZMmZmFzyMLLzMDAAAAMmhlZmZGwYGDLwAbDLYsgBAAAAAAwwYGAA",
				},
				[2] = {
					label = "The Stonevault",
					talentString = "CsQAAAAAAAAAAAAAAAAAAAAAAAmZmZmZghhxsNzMDzysZMmxsY2MLLzMDAAAAMzMsMzMzAGzYYBGYbYBjFMAAAAAAAGmZGAA",
				},
				[3] = {
					label = "The Dawnbreaker",
					talentString = "CsQAAAAAAAAAAAAAAAAAAAAAAAmZmZmZgZzAz2MzMMLzmBzMziZzstYmBAAAAmZGWmZmZAjZMsADsNsgxCGAAAAAAAjZmZAA",
				...
				[5] = {
					label = "Mists of Tirna Scithe",
					talentString = "CsQAAAAAAAAAAAAAAAAAAAAAAAmZmZmZgZzwY2MzMMLzmBzMziZzssMzMAAAAwMzwyMzMDYMjhFYgthFMWwAAAAAAAYYmZAA",
				},
				[6] = {
					label = "City of Threads",
	...
	[10] = {
		specs = {
			[268] = {
				[0] = {
					label = "The Stonevault",
					talentString = "CwQAAAAAAAAAAAAAAAAAAAAAAAAAAAGzMmBmFzsNmZGAAAAAAAWWAYmBmhBDjtZMjZ2GzM2mlZst9ALWmZGzsAAALz2YZ2mZZAAAAwgF",
				},
				[1] = {
					label = "The Dawnbreaker",
				...
				[3] = {
					label = "Mists of Tirna Scithe",
					talentString = "CwQAAAAAAAAAAAAAAAAAAAAAAAAAAAzYMmBmFsNzMzYAAAAAAAWWAYmBmhxGw2MzMMbjZGbzyMW2mFbzMjZWAAglZZsMbzsMAAAAGD2A",
				},
				[4] = {
					label = "City of Threads",
					talentString = "",
				...
				[5] = {
					label = "Grim Batol",
					talentString = "CwQAAAAAAAAAAAAAAAAAAAAAAAAAAAzYMmhxsxDsNzMzAAAAAAAgFMMzMDMDzwMYZmZGzsxMjNLGLbzilZmhZDAAWmlx2sNzyAAAAgBLA",
				},
			},
			[270] = {
				[0] = {
	...
	[11] = {
		specs = {
			...
			[104] = {
				...
				[2] = {
					label = "The Stonevault",
					talentString = "CgGAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAzMzMzYWGWmZmxwswwMzmlBYGDmZmhxMzMmZmhBbAAAAAAAMmxAAAAAzsNLzMLDAgFGzAA",
				},
			},
		},
	},
	[13] = {
		specs = {
			[1473] = {
				...
				[3] = {
					label = "Grim Batol",
					talentString = "CEcBAAAAAAAAAAAAAAAAAAAAAgZZsMzMzYZGmZWmxMDzsBAAAAAAAgZGYYMGGmZGAAAAYmZ2GzMbjZGDjNDMmNLsADMDDGYBjB",
				},
			},
			[1467] = {
				[0] = {
			...
			[1468] = {
				...
				[3] = {
					label = "The Dawnbreaker",
					talentString = "CwbBAAAAAAAAAAAAAAAAAAAAAAAAAAAmxMz2sMwwMzMLmZGDYAAwMjZMjxwMYMDAAAYmZGGbzMGjZAAYMbWYBGYGGMYsAzA",
				},
				[4] = {
					label = "Siege of Boralus",
				...
				[5] = {
					label = "Mists of Tirna Scithe",
					talentString = "CwbBAAAAAAAAAAAAAAAAAAAAAAAAAAAmZmZ2mlBGzMjZxMzYAAAwMjZMjxwMYmZAAAAzMzwYZmxYMDAAjZzCLwAzwgBjFYA",
				},
				[6] = {
					label = "City of Threads",
				...
				[7] = {
					label = "Grim Batol",
					talentString = "CwbBAAAAAAAAAAAAAAAAAAAAAAAAAAAmZmZ2mtBGzMjZxMzYAAAwMjZMjxwMYMDAAAYmZGzYZmxYMDAAjZzCLwAzwgBjFYG",
				},
			},
		},
	},
}
addonTable.WorldwideMythicDB = talentData