	...
	[2] = {
		specs = {
			[65] = {
				...
				[6] = {
					label = "Seat",
					talentString = "CEEAAAAAAAAAAAAAAAAAAAAAAAAAAYBAMDAwglxMYGzMzCjx4BWGbzMLmpJGzYmZYY2yAwAwGYjtZmZWmtZmZrBAAAYhFAbGYGzgBAwMDzYMMA",
				},
				[7] = {
					label = "Skyreach",
