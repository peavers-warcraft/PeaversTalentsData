	...
	[7] = {
		specs = {
			[262] = {
				...
				[1] = {
					label = "Algethar Academy",
					talentString = "CYQAAAAAAAAAAAAAAAAAAAAAAAAAAAzMbbzMzYML2mhZMzAAAAAAbmxwGsAzwQjNAYWmZmxMbLmYmZMWm5BmZMsMLGLmZGzsAAMDwMDMMMA",
				},
				[2] = {
					label = "Magisters",
	...
	[10] = {
		specs = {
			...
			[269] = {
				...
				[7] = {
					label = "Skyreach",
					talentString = "C0QAAAAAAAAAAAAAAAAAAAAAAMzYMYMYbmZ2mxAAAAAAAAAAAALDjmxMMMghhZGzMmNbmhZZmAAWMz2YYMzMAA2AgZZWamZmFghBmZAYsMAGwA",
				},
				[8] = {
					label = "Windrunner Spire",
					talentString = "C0QAAAAAAAAAAAAAAAAAAAAAAMzYMYMYbmZ2mxAAAAAAAAAAAALDzEmhhBMMjZmZGmNMDzyMBAsYmtxwYmZAAsBAzys0MzMLAjZgZGAGLDgBM",
	...
	[13] = {
		specs = {
			...
			[1468] = {
				...
				[2] = {
					label = "Magisters",
					talentString = "CwbBAAAAAAAAAAAAAAAAAAAAAAAAAAAmZmZ2WGYYmxsZGjx2wAAAzwMzYMMTMzMAAAw2MzMNDzMzsMmBAgxM2YBGYGGaALwYmBgB",
				},
				[3] = {
					label = "Maisara Caverns",
