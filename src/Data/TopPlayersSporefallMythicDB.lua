	...
	[12] = {
		specs = {
			[577] = {
				[0] = {
					label = "Rotmire",
					talentString = "CEkAAAAAAAAAAAAAAAAAAAAAAYmZGzMz2MmZmZmZmwMDAAAAAAYYMbzwMDmZsNbzDMzYMGWGYbWMjhZjpxMzYGbAAAAAAAAMzgBAAAgB",
				},
			},
			[581] = {
				[0] = {
...
addonTable.TopPlayersSporefallMythicDB = talentData