	...
	[1] = {
		specs = {
			...
			[72] = {
				[0] = {
					label = "All Bosses",
					talentString = "CgEAAAAAAAAAAAAAAAAAAAAAAAAAAAAAgGDjZMzyyMzMjZmxMjZMjZWmZGjZmlxMzAAAhB2glFjGzAYWwMWAMDGDAmZAMMzMDG8A",
				},
				[1] = {
					label = "Rotmire",
					talentString = "CgEAAAAAAAAAAAAAAAAAAAAAAAAAAAAAgGDzMmZ2WmZmZmxMmZmZMjZWmZGjZmtxMzAAAxYZZgFwAmhJwgNAzgZbAAwMjhxMDG8A",
					instanceId = 1305,
	...
	[2] = {
		specs = {
			...
			[70] = {
				[0] = {
					label = "All Bosses",
					talentString = "CYEAAAAAAAAAAAAAAAAAAAAAAAAAAAAQz22MzsMMzAAAAAAwoMmhZGbDz2wMbzYMmZYGbsNAAAmZabmZbGAwGgBwYMDzgZMmNsMDGGzYwDA",
				},
				[1] = {
					label = "Rotmire",
				...
				[2] = {
					label = "Imperator Averzian",
					talentString = "CYEAAAAAAAAAAAAAAAAAAAAAAAAAAAAQz22MzsMMzAAAAAAwMlxMMzYbY2GmZbGjxMDzYDDDAAMz02Mz2MAgNADAGzwMYGjZDLzghxMG8A",
					instanceId = 1307,
					instanceName = "The Voidspire",
				},
				[3] = {
				...
				[4] = {
					label = "Vaelgor & Ezzorak",
					talentString = "CYEAAAAAAAAAAAAAAAAAAAAAAAAAAAAQz22MzsMGzMDAAAAAwoMmhZGbDz2wMbzYmxYYGbsBAAwMTbzMbzAA2AMAYMDzgZmZshlZwwYGDeA",
					instanceId = 1307,
					instanceName = "The Voidspire",
				},
				[5] = {
	...
	[3] = {
		specs = {
			[253] = {
				[0] = {
					label = "All Bosses",
					talentString = "C0PAAAAAAAAAAAAAAAAAAAAAAAMmxwCsAzwQDbAAYGPwyMzsYGmZmZGzMMzMmhZGzMzYbmZMjZwYaGAAAAAAAAgZMGwMbAwsA2eAA",
				},
				[1] = {
					label = "Auriaya",
					talentString = "C0PAAAAAAAAAAAAAAAAAAAAAAAMmxwCsAzwQDbAAYGPwyMzsYGmZmZGzMMzMmhZGzMzYbmZMjZwYaGAAAAAAAAgZMGwMbAwsA2eAA",
				...
				[16] = {
					label = "Crown of the Cosmos",
					talentString = "C0PAAAAAAAAAAAAAAAAAAAAAAAMmxwCsAzwQDbAAYG2GzsNzwMmZYYmxYmxMzYGzwMzYGzgx0MAAAAAmBAAgxMzMgZ2AbwsA2eAA",
					instanceId = 1307,
					instanceName = "The Voidspire",
				},
				[17] = {
					label = "Belo'ren, Child of Al'ar",
					talentString = "C0PAAAAAAAAAAAAAAAAAAAAAAAMmxwCsBzwQDbAAYG2GzsNzwMmZYYmxYmxMzYGzYZmZMjZwDYaGAAAAAzAAAwYmZGwMbgNYWAbPAA",
					instanceId = 1308,
					instanceName = "March on Quel'Danas",
				},
				[18] = {
			...
			[254] = {
				[0] = {
					label = "All Bosses",
					talentString = "C4PAAAAAAAAAAAAAAAAAAAAAAwCMwMGN2GAzgNAAAAAAAAgZMjZ2MPgZGzMs9AmmZmxMbLbzYmlZmZmZmNYbYGAAgZm5BMzAMzYBLzAgHgZA",
				},
				[1] = {
					label = "Rotmire",
					talentString = "C4PAAAAAAAAAAAAAAAAAAAAAAwCMwMGN2GAzgNAAAAAAAAgZMjZ2MPgZGzMs9AmmZmxMbLbzYmlZmZmZmNYbYGAAgZm5BMzAMzYBLzAgHgZA",
			...
			[255] = {
				...
				[1] = {
					label = "Rotmire",
					talentString = "C8PAAAAAAAAAAAAAAAAAAAAAAMgxMG2gFYGGawiZmZmZYZAAAAAAwMmZmhZMmxMYMNDAAAADAMWWmZmFzMzYMmZAzsBYYMmZ28AA",
					instanceId = 1305,
					instanceName = "Sporefall",
				},
				[2] = {
					label = "Imperator Averzian",
					talentString = "C8PAAAAAAAAAAAAAAAAAAAAAAMgxMGWgFYGGawiZmZmZYZAAAAAAwMzMzM2mxYGzgx0MAAAAMAALLzMziZmZGGjBMzGghxYmZzDAA",
					instanceId = 1307,
					instanceName = "The Voidspire",
				},
				[3] = {
					label = "Vorasius",
					talentString = "C8PAAAAAAAAAAAAAAAAAAAAAAMgxMGWgFYGGawixMzMzYZAAAAAAwMmZmBjxMmBjpZAAAAYAgxyyMzsYmZmxMzYAzsBYYMmxmHAA",
					instanceId = 1307,
					instanceName = "The Voidspire",
				},
				[4] = {
	...
	[4] = {
		specs = {
			...
			[261] = {
				...
				[1] = {
					label = "Rotmire",
					talentString = "CUQAAAAAAAAAAAAAAAAAAAAAAAgx2MAAAAAwsMGLTMbbjxMjZMegZmZGjZbYGbLzMzMzMjBjZ2GAAAAGMGwY2MMwAzCL0iNMDYmBz4BA",
					instanceId = 1305,
					instanceName = "Sporefall",
				},
				[2] = {
					label = "Imperator Averzian",
					talentString = "CUQAAAAAAAAAAAAAAAAAAAAAAAgx2MAAAAAwsMGLTMbbjxMjZMMzMzYMbjZGbbzMzMzMjBjZ2GAAAAGMGwY2MMwAzCL0iNMDYmBz4BA",
					instanceId = 1307,
					instanceName = "The Voidspire",
				},
				[3] = {
	...
	[5] = {
		specs = {
			[256] = {
				[0] = {
					label = "All Bosses",
					talentString = "CAQAAAAAAAAAAAAAAAAAAAAAAADsAzCjZYmZMbzsNzMzMMDAAAAAAAAAgZYZGMzMDzwMgpZamBYmFMEGzyAMGsAAAjxMjBzAMzMjZ4BA",
				},
				[1] = {
					label = "Rotmire",
					talentString = "CAQAAAAAAAAAAAAAAAAAAAAAAADsAz2MzMYmhZbmtZmZmhZAAAAAAAAAAMDLzgZmZwwMwMNTzMAzsghwYWGgxgFAAYMmZMYGgZmZMDPA",
					instanceId = 1305,
					instanceName = "Sporefall",
				},
				[2] = {
				...
				[7] = {
					label = "Crown of the Cosmos",
					talentString = "CAQAAAAAAAAAAAAAAAAAAAAAAADswwyMzMDMmZxsNzMjxMDAAAAAAAAAgZMLjxMMjthZGYmmpZGgZ2wQYMLDwYwCAAMmZMzgZAmZGgHA",
					instanceId = 1307,
					instanceName = "The Voidspire",
				},
				[8] = {
			...
			[258] = {
				...
				[1] = {
					label = "Rotmire",
					talentString = "CIQAAAAAAAAAAAAAAAAAAAAAAMMjZGAAAAAAAAAAAgxMMjxyMDzsMzwMsNzMmZmxGyMWMTDwMAzsZGmNDAZMWAwMAjZmZMbjZ2WGgZwDA",
					instanceId = 1305,
					instanceName = "Sporefall",
				},
				[2] = {
	...
	[6] = {
		specs = {
			[250] = {
				...
				[1] = {
					label = "Rotmire",
					talentString = "CoPAAAAAAAAAAAAAAAAAAAAAAwMzyMzMmxMmhZbmZmmZxMjxMGAAAAwMmZmZmZYGjBAjZmZGAAADMwMW0YZBwyA2AMDzAAAzMwwDA",
					instanceId = 1305,
					instanceName = "Sporefall",
				},
				[2] = {
			...
			[251] = {
				[0] = {
					label = "All Bosses",
					talentString = "CsPAAAAAAAAAAAAAAAAAAAAAAMAzMMjxYY2mZmZmZbGjmZMmZYGGPgZmZmZmZMDAAAAAAAAAjZbgBsAWGmAjFMzYmZgBghZGAzgHA",
				},
				[1] = {
					label = "Imperator Averzian",
					talentString = "CsPAAAAAAAAAAAAAAAAAAAAAAMDYmhZMzYY2mZmZmZzMjmZMGDzwgZmZmZmZmZAAAAAAAAAYMbDMgFwywEYsgZGzMDMAMMzAYgHA",
					instanceId = 1307,
					instanceName = "The Voidspire",
				},
				[2] = {
				...
				[3] = {
					label = "Vaelgor & Ezzorak",
					talentString = "CsPAAAAAAAAAAAAAAAAAAAAAAMDYmZMzMDY2mZmZmZzMjMjxMDzw4BMzgZmZmZAAAAAAAAAYMbDMgFwywEYsgZGzMDMDghZGgZgHA",
					instanceId = 1307,
					instanceName = "The Voidspire",
				},
				[4] = {
			...
			[252] = {
				...
				[7] = {
					label = "Crown of the Cosmos",
					talentString = "CwPAAAAAAAAAAAAAAAAAAAAAAAwMjZmZYY2mZmZa2MzYMjBAAAAAAAgZGzYAwyMmZ2MzYMDYzsZYgBmNGasgBMDAjZmxMAzMzY8AA",
					instanceId = 1307,
					instanceName = "The Voidspire",
				},
				[8] = {
	...
	[7] = {
		specs = {
			[262] = {
				...
				[14] = {
					label = "Painsmith Raznal",
					talentString = "CYQAAAAAAAAAAAAAAAAAAAAAAAAAAAzMbLzMzYML2mhZMzAAAAAAbmxwGsAzwQjNAY2mZmxMbLzEzM2GLzYm5BGWsMjFzMjZWAAGAzMwwwDA",
					instanceId = 1193,
					instanceName = "Sanctum of Domination",
				},
				[15] = {
					label = "Fatescribe Roh-Kalo",
					talentString = "CYQAAAAAAAAAAAAAAAAAAAAAAAAAAAzMbLzMzYML2mhZMzAAAAAAbmxwGsAzwQjNAY2mZmxMbLzEzM2GLzYm5BGWsMjFzMjZWAAGAzMwwwDA",
					instanceId = 1193,
					instanceName = "Sanctum of Domination",
				},
				[16] = {
					label = "Remnant of Ner'zhul",
					talentString = "CYQAAAAAAAAAAAAAAAAAAAAAAAAAAAzMbLzMzYML2mhZMzAAAAAAbmxwGsAzwQjNAY2mZmxMbLzEzM2GLzYm5BGWsMjFzMjZWAAGAzMwwwDA",
					instanceId = 1193,
					instanceName = "Sanctum of Domination",
				},
				[17] = {
					label = "The Eye of the Jailer",
					talentString = "CYQAAAAAAAAAAAAAAAAAAAAAAAAAAAzMbLzMzYML2mhZMzAAAAAAbmxwGsAzwQjNAY2mZmxMbLzEzM2GLzYm5BGWsMjFzMjZWAAGAzMwwwDA",
					instanceId = 1193,
					instanceName = "Sanctum of Domination",
				},
				[18] = {
					label = "Soulrender Dormazain",
					talentString = "CYQAAAAAAAAAAAAAAAAAAAAAAAAAAAzMbLzMzYML2mhZMzAAAAAAbmxwGsAzwQjNAY2mZmxMbLzEzM2GLzYm5BGWsMjFzMjZWAAGAzMwwwDA",
					instanceId = 1193,
					instanceName = "Sanctum of Domination",
				},
				[19] = {
					label = "Guardian of the First Ones",
					talentString = "CYQAAAAAAAAAAAAAAAAAAAAAAAAAAAzMbLzMzYML2mhZMzAAAAAAbmxwGsAzwQjNAY2mZmxMbLzEzM2GLzYm5BGWsMjFzMjZWAAGAzMwwwDA",
					instanceId = 1193,
					instanceName = "Sanctum of Domination",
				},
			...
			[263] = {
				[0] = {
					label = "All Bosses",
					talentString = "CcQAAAAAAAAAAAAAAAAAAAAAAMzMzYmZmZmZmhZmZAAAAAAAAAsBYzMG2gFYGGawCAzyMmZGLLzAzMbsMzMzwwYGAgZYYGzMBmZAMeAA",
				},
				[1] = {
					label = "Rotmire",
					talentString = "CcQAAAAAAAAAAAAAAAAAAAAAAMzMzYmZmZmZmhZmZAAAAAAAAAsBYzMG2gFYGGawCAzyMmZGLLzAzMbsMzMzwwYGAgZYYGzMBmZAMeAA",
			...
			[264] = {
				...
				[1] = {
					label = "Yogg-Saron",
					talentString = "CgQAAAAAAAAAAAAAAAAAAAAAAAAAAgBAAAAjZmZZbZMzMzYmZGDDLwGMjFN2GAzAbYmBz2MzMaWWmZwY2YZGzMmhZZGAAGAzMYmBgxgHA",
					instanceId = 759,
					instanceName = "Ulduar",
				},
				[2] = {
					label = "Rotmire",
					talentString = "CgQAAAAAAAAAAAAAAAAAAAAAAAAAAgBAAAAzMzMLLbDzMGzMzMzYGLwCMjFN2GAzAbmhB2GjZa2WmZYGzCLmZmxMMLDAAAMzMYmBAG8A",
					instanceId = 1305,
					instanceName = "Sporefall",
				},
				[3] = {
	...
	[8] = {
		specs = {
			...
			[64] = {
				...
				[6] = {
					label = "Lightblinded Vanguard",
					talentString = "CAEAAAAAAAAAAAAAAAAAAAAAAMzwYZmZmFegZmYmZGzMzMziZmZMjZAAAgZmZWWmZaDAAAAAAsAw22YmZmHgZbYMDLAAAMzGwMMGwM4BA",
					instanceId = 1307,
					instanceName = "The Voidspire",
				},
				[7] = {
	...
	[9] = {
		specs = {
			[265] = {
				[0] = {
					label = "All Bosses",
					talentString = "CkQAAAAAAAAAAAAAAAAAAAAAAYmZMzoZzM2mZGzGAAwMzsMLmZWMDAYBGY2MaMDgZDsMAAAYAAgZGMmZMzyYgxMzMz8AMzMGAwMwDA",
				},
				[1] = {
					label = "Rotmire",
					talentString = "CkQAAAAAAAAAAAAAAAAAAAAAAYmZMzoZzM2mZGzGAAwMzsMLmZWMDAYBGY2MaMDgZDsMAAAYAAgZGMmZMzyYgxMzMz8AMzMGAwMwDA",
			...
			[266] = {
				[0] = {
					label = "All Bosses",
					talentString = "CoQAAAAAAAAAAAAAAAAAAAAAAwMmZGNbM2mZGzyAAAAAAAAGzYYBGYbYhGWMYmlZbmZGzAAzwMzMzMAjZMzsBAAmZmZGDjZZGD4BA",
				},
				[1] = {
					label = "Rotmire",
			...
			[267] = {
				...
				[6] = {
					label = "Crown of the Cosmos",
					talentString = "CsQAAAAAAAAAAAAAAAAAAAAAAwMzMzoZjhZmZmlZZmZmZxY2W8ADAAmZGzMziFYgZxoxMAmNsxAAAjBYDAYmBmZMGAAAmZmZAAMGeA",
					instanceId = 1307,
					instanceName = "The Voidspire",
				},
			},
	...
	[10] = {
		specs = {
			[268] = {
				...
				[1] = {
					label = "Rotmire",
					talentString = "CwQAAAAAAAAAAAAAAAAAAAAAAAAAAwMLbGDmxyMWMzMDAAAAAAALLYmwMwMMWMDmZmZMz2wMmZZYZzy2sNjZBAA2AAAAz2s0MzMbMsBwMDTjBAA8AA",
					instanceId = 1305,
					instanceName = "Sporefall",
				},
				[2] = {
			...
			[270] = {
				...
				[1] = {
					label = "Rotmire",
					talentString = "C4QAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAgxMWmBzitZGzMbGbLbzYmNzsttMzYhZmmxMgBDwyMzMDz2gBLzEAAAAAAsYZmlZZmJAAADAzAGglJjZA",
					instanceId = 1305,
					instanceName = "Sporefall",
				},
				[2] = {
				...
				[8] = {
					label = "Belo'ren, Child of Al'ar",
					talentString = "C4QAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAM2mB2sYGzMLzYDzMDzsstMzYhZ0MmBMYwwyMzMDz2gBLzEAAAAAAsYZmlZbmJAAMgBYGwYYsIjZA",
					instanceId = 1308,
					instanceName = "March on Quel'Danas",
				},
				[9] = {
					label = "Chimaerus the Undreamt God",
					talentString = "C4QAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAM2mB2sYGzMLzYDzMDzsstNzYhZ0MmBMYwwyMzMDz2gBLzEAAAAAAsYZmlZbmJAAMgBYGwYYsIjZA",
					instanceId = 1314,
					instanceName = "The Dreamrift",
				},
			},
	...
	[11] = {
		specs = {
			[102] = {
				...
				[1] = {
					label = "Rotmire",
					talentString = "CYGAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAWoMbNjxMDMmFmZmBYGz2MLjthZmtxyMGzMDbYYAGgltxGmmZWGAAAAsxMzMD22GGjZAMzAAPAA",
					instanceId = 1305,
					instanceName = "Sporefall",
				},
				[2] = {
					label = "Imperator Averzian",
					talentString = "CYGAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA2oMbZMmZgxsMzMzMLMeAMmZZmFzMzsMWmZZMzgNMAYstMzgxsMAmAAAAswMzMD2MMGDAAzMwDA",
					instanceId = 1307,
					instanceName = "The Voidspire",
				},
				[3] = {
			...
			[103] = {
				[0] = {
					label = "All Bosses",
					talentString = "CcGAAAAAAAAAAAAAAAAAAAAAAAAAAAAgZMzmZMzMGzmx2YbmZm5BmZAAAAYLY2gxMjaGziZmZGjZYAAAAAAMwAAAAAAMbzs0sMzyGmZmBYhBDAgZGA8AA",
				},
				[1] = {
					label = "Rotmire",
					talentString = "CcGAAAAAAAAAAAAAAAAAAAAAAAAAAAAgZMzmZMzMGzmx2YbmZm5BmZAAAAYLY2gxMjaGziZmZGjZYAAAAAAMwAAAAAAMbzs0sMzyGmZmBYhBDAgZGA8AA",
	...
	[13] = {
		specs = {
			[1467] = {
				[0] = {
					label = "All Bosses",
					talentString = "CsbBAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAgZmZgZ8AzgBGGjZaMzMNjx2MmZmZGzMzAmZmxYmZZmZgBGDWglxox2AYGEshZwMDGeA",
				},
				[1] = {
			...
			[1473] = {
				[0] = {
					label = "All Bosses",
					talentString = "CEcBAAAAAAAAAAAAAAAAAAAAAMmZmZbmZGMYmZZGjhZ2AAAAAgBAAzMDMYM1YmZGAAAAMjZmxMz2YmBmZxAjZswCMwMM0ALYmxMDA8A",
				},
				[1] = {
					label = "Rotmire",
					talentString = "CEcBAAAAAAAAAAAAAAAAAAAAAMmZmZbmZGMYmZZGjhZ2AAAAAAAAwMw8AYmpGzMzAAAAAzMzMmZWGzMwMbGDWglxoxyAYGEbYmZwMDM8A",
					instanceId = 1305,
					instanceName = "Sporefall",
				},
				[2] = {
